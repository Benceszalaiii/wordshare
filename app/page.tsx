    ...
    <div className="flex flex-col items-center">
      ...
      <div className=" w-full max-w-4xl px-5 py-32 xl:px-0">
        ...
        <div className="mt-8 flex w-full justify-center items-center">
          <a className="rounded-3xl border-2 border-main-500 bg-main-600/25 bg-gradient-to-bl from-white/25 to-main-500/50 p-3 font-bold text-black antialiased backdrop-blur-3xl transition-all duration-300 ease-out hover:scale-105 hover:bg-gradient-to-tr hover:from-main-400 hover:to-main-700/50 hover:underline dark:text-white" href={"/quickstart"}>
            Get started now!
          </a>
        </div>
      </div>
