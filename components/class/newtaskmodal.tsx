...
export function NewTaskModal({
    ...
    return (
        <>
            <ModalTrigger className="h-full w-full text-start">
                {children}
            </ModalTrigger>
    ...
    if (isMobile) {
        return (
            <>
                ...
                <DrawerContent className="pointer-events-auto px-6 pb-12">
                    <DrawerHeader>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-col">
                                        ...
                                        <FormDescription>
                                            Give your task a clear name, as this
                                            will be the primary field for
                                            students to navigate between tasks.
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
