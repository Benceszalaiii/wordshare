    ...
    <>
      <div className="mx-4 mt-6 flex grow flex-col gap-6 md:flex-row">
        <Card className="flex grow basis-1 flex-col">
          ...
          <CardContent>
            <CardDescription>
              As a student you will be able to join a class, submit essays and
              practice words.
            </CardDescription>
          </CardContent>
          <CardFooter className="flex flex-1 grow flex-col items-center justify-end">
            ...
            <CardDescription className=" text-neutral-500 dark:text-neutral-500">
              You need to be a part of a class to access all features.
            </CardDescription>
          </CardFooter>
        </Card>
        <Card className="grow basis-1">
          ...
          <CardContent>
            <CardDescription>
              As a teacher you will be able to create classes, assign essays and
              practice words.
            </CardDescription>
          </CardContent>
          <CardFooter className="flex flex-1 grow flex-col items-center justify-end">
