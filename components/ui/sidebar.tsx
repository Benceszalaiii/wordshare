    ...
    (
        ...
        return (
            ...
            >
                ...
                <div
                    className={cn(
                        "relative h-svh w-[--sidebar-width] bg-dark transition-[width] duration-200 ease-linear",
            ...
            <Tooltip>
                <TooltipTrigger asChild>
                    <Button
                        ...
                        size="icon"
                        className={cn(
                            "sticky top-20 z-20 ml-8 h-10 w-10 rounded-lg",
                            className,
                        )}
                        onClick={(event) => {
                            onClick?.(event);
                ...
                <TooltipContent>
                    <p>
                        Toggle Sidebar <span className="text-gray-500">⌘B</span>
                    </p>
                </TooltipContent>
            </Tooltip>
        </TooltipProvider>
