    ...
    return (
        <div className={cn("relative block md:hidden", className)}>
                        ...
                        {items.map((item, idx) => (
                            ...
                            >
                                <Link
                                    href={item.href}
                                    key={item.title}
                                    className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-50/95 dark:bg-neutral-900/95"
                                >
            ...
            <button
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-50/95 dark:bg-neutral-800/95"
            >
                <ChevronUpIcon
                    className={`h-5 w-5 text-neutral-500 transition-transform duration-500 dark:text-neutral-400 ${open && "-scale-y-100"}`}
                />
            </button>
        </div>
    );
